    ...
    <div className="min-h-screen bg-[#f8f9fa] flex items-center justify-center p-6 py-20">
      <div className="max-w-md w-full bg-white rounded-[2.5rem] p-10 shadow-2xl animate__animated animate__fadeIn">
        <div className="text-center mb-10">
          <div className="w-16 h-16 bg-[#0d6efd] rounded-full flex items-center justify-center text-white text-3xl mx-auto mb-4 shadow-lg animate__animated animate__bounceIn">
            🌊
          </div>
          <h1 className="text-3xl font-black text-gray-900 tracking-tight">Welcome Back</h1>
          <p className="text-gray-500 font-medium mt-2">Login to manage your summer kit</p>
        </div>
